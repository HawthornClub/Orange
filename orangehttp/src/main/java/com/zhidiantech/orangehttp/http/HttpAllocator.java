...
import com.zhidiantech.orangehttp.interceptor.HeaderInterceptor;
import com.zhidiantech.orangehttp.util.JsonFormat;
import com.zhidiantech.orangehttp.util.HttpLogUtil;
            ...
            HttpLoggingInterceptor loggingInterceptor=new HttpLoggingInterceptor(new HttpLoggingInterceptor.Logger() {
                ...
                public void log(String message) {
                    ...
                    if (message.startsWith("<-- END HTTP")) {
                        HttpLogUtil.showLog(TAG,mMessage.toString());
                    }
                }
